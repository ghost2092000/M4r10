...
function setUpObjectArray() {
    ...
    arr.push([1., 0, -1.4, -4.0, 4, 0.5, 1., 20]);
    arr.push([1., 2.4, 0.0, -4.0, 1.0, 0.5, 1., 25]);
    arr.push([1., 3, -1.2, -4.0, .1, 1    , 1., 25]);
	arr.push([1., 4.8, -1.2, -4.0, .1, 1    , 1., 25]);
	arr.push([1., 8.0, -1.2, -4.0, 4.3, 0.5, 1., 25.]);//20
    ...
    arr.push([1., 73.0, -1.2, -4.0, 2.5, 0.5, 1., 25.]);
...
///////////////////////  
  var arr = [];
    ...
    arr.push([current_x + 1, current_x,    0.3, -4.0, xscale, yscale, zscale, 0]);
