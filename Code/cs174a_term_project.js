...
// lighting
var lightPosition = vec3(1.0, 4.0, 8.0);
...
var audio = new Audio("../Audio/_Inner Animal_ - Scattle (Hotline Miami OST).mp4");
if(play) {
    audio.play();
  }
...
window.onload = function init() {
    ...
    myTextureBear.image.src = "../Images/running_bear1222.png";
    ...
    myTextureBricks.image.src = "../Images/brick-cartoon.png";
    ...
    myTextureSwipe.image.src = "../Images/8bitbear1.png";
   ...
   {myTextureBackground_6.image.src = "../Images/royce.png";}   
    ...
    myTextureEnemy.image.src = "../Images/plant22.png";
   ...
   myTextureBearDead.image.src = "../Images/running_bear1222ee copy.png";
    ...
    projectionMatrix = perspective(  75 , canvas.clientWidth / canvas.clientHeight, 0.001, 10000);
...
{    
    ...
    gl.uniform1f(UNIFORM_shininess, 10);
   ...
   /////////////////////////////////////
    ...
    if (current_x > 70.0)
    {
        ...
        if (!victoryPlayed)
        {
          playAudio("../Audio/Jasper Byrne - Miami.mp3");
		  victoryPlayed = true;
   ...
   /////////////////////
    ...
    for (var i = 0; i < enemyArr.length; ++i)
    {
        ...
        mvMatrix = mat4();
        mvMatrix = mult(mvMatrix, rotate(20, 1, 0, 0)); // angle camera
        mvMatrix = mult(mvMatrix, translate(enemyArr[i][1] - movx, enemyArr[i][2], enemyArr[i][3] + z_zoom));
        mvMatrix = mult(mvMatrix,rotate(time * omega, 0, 0, 3));
    ...
    {    
        ...
        {
            horiz = -player_x - 0.05;
            altitude = respawnArr[respawnPoint][0] ;
    ...
    if (!playerDiedAnimation)
    {
        ...
        else if (keysPressed[37]) // LEFT
        {
            if (!blockedLeft)
            {
				...
				//curent x is just ground moving 
